...
//
    ...
    enqueue(node){
        if(this.front == null){
            ...
            if(this.highestPriority[0] == null){
                this.highestPriority.push(node);
            }else{
                if(this.highestPriority[this.highestPriority.length-1].priority < node.priority){
                    this.highestPriority[this.highestPriority.length-1] = node;
                }else{
                    this.highestPriority.push(node);
                }
            }
    ...
    dequeue(){
        if(this.front == null){
            ...
            //Logic to deal with highest priority array
