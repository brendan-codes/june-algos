...
class priorityQueue {
    constructor(){
        ...
        this.rear = null;
        this.length = 0;
        this.highestPriority = [];// need an array
    }
    ...
    enqueue(node){
        if(this.rear === null){
            this.rear = node;
            this.front = node;
            this.highestPriority.push(node);
            this.length++;
        }else{
            this.rear.next = node;
            this.rear = node;
            ...
            for(var i = 0; i<this.highestPriority.length; i++){
                if(this.highestPriority[i].priority>=node.priority){
                    this.highestPriority.splice(i,0,node);
                    return;
                }
            }
            this.highestPriority.push(node);
    ...
    dequeue(){
        ...
        this.length--;
        for(var i = 0; i<this.highestPriority.length; i++){
            if(this.highestPriority[i]===node){
                this.highestPriority.splice(i,1);
                break;
            }
        }
        return node;
    ...
    getHighestPriority(){
        return this.highestPriority[this.highestPriority.length-1];
    }
}
