...
class SLL {
    ...
    partition(val) {
        ...
        while(runner){
            if (runner.data < val){
                array1.push(runner.data);
            }
            else if (runner.data > val){
                array2.push(runner.data);
            }
            else if (runner.data === val) {
        ...
        let index = 0;
        runner1 = this.head;
        while(runner !== null && index < array1.length){
            runner.data = array1[index];
        }

        index = 0;

        while(runner !== null && index < array2.length){
            runner.data = array2[index];
        }
